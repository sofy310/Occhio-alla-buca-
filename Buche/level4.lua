...
local function createRuota()
    ...
    if ( whereFrom == 1 ) then
        ...
        newRuota.y = -100
        newRuota:setLinearVelocity(0, 187 )
...
local function createCar1()
    ...
    if ( whereFrom == 1 ) then
        ...
        newCar1.y = -100
        newCar1:setLinearVelocity(0, math.random( 220,350 ) )
...
local function createBuca1()
    ...
    if ( whereFrom == 1 ) then
        ...
        newBuca1.y = -100
        newBuca1:setLinearVelocity(0, 187 )
    elseif ( whereFrom == 2 ) then
...
local function createBuca2()
	...
	if ( whereFrom == 1 ) then
        ...
        newBuca2.y = -100
        newBuca2:setLinearVelocity(0, 187 )
    elseif ( whereFrom == 2 ) then
...
local function createBuca3()
	...
	if ( whereFrom == 1 ) then
        ...
        newBuca3.y = -100
        newBuca3:setLinearVelocity(0, 187 ) 
    elseif ( whereFrom == 2 ) then
        -- From the topRight
